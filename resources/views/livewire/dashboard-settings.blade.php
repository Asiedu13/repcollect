        ...
        <section x-data="{save: false}" class="flex flex-col gap-5 border border-gray-200 rounded-lg p-4">
          ...
          <section class="text-neutral">
            <div>
              ...
              <input 
              wire:model="momo"
              @save-methods.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'bg-white p-0 my-0 font-medium bg-white text-primary border rounded-md p-2')" 
              @edit-methods.window="$el.removeAttribute('disabled'); $el.setAttribute('class', 'p-2 border text-primary border-blue-400 rounded-md outline-blue-400 placeholder:text-blue-400')" id="momo"
              class="font-medium bg-white text-primary border rounded-md p-2" 
              type="text" 
              name="momo" 
              placeholder="+233" 
              disabled 
