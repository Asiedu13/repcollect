                ...
                <div class="flex flex-1 justify-between lg:w-full">
                    <div class="flex flex-col">
                        <div class="flex justify-between items-center">
                            ...
                            <!-- Save button -->
                            <button x-show="save"  @click="$dispatch('save-collection-meta'); save = false; $wire.updateCollection(); $refresh" class="flex items-center justify-center gap-2 border border-gray-200 py-2 px-4 rounded-full text-gray-400 text-sm font-medium w-fit h-fit self-center hover:bg-gray-400 hover:text-white delay-150">
                                Save
