...
<section class="flex-1 bg-primary text-secondary rounded-md my-5 w-2/4 .px-4 lg:absolute right-5 shadow-lg">
    <div class="flex gap-2 text-secondary font-semibold items-center py-2 px-4 justify-between">

        <div class="flex gap-2">
            <a href="{{route('home')}}" class="flex gap-2 font-normal items-center text-sm  border-gray-400 border-r-2  pr-4">RepCollect </a>
            ...
            <a href="{{route('login')}}" class="text-secondary rounded-md p-2 text-sm hover:bg-gray-500 hover:text-primary gap-2 flex text-right" wire:navigate> 
                Get payment link
    ...
    <hr>
     ...
     <section class="px-4 py-4">
        <header class="py-4 text-gray-700 flex">
            <div class="">
                <h2 class="capitalize text-2xl  font-medium"> Campus Farming: Grow and Give Back </h2>
                <p class="text-sm px-1 my-2 max-h-[80px] w-3/4">  Establishing an organic garden on campus where students can grow their own produce and donate a portion of the harvest to local food banks, promoting sustainable food practices. </p>
            </div>

            <div class="max-w-[600px] w-[600px] max-h-[inherit] h-[inherit] overflow-clip .border-2">
                <b class=" text-lg">Goal: <span>GHS 1000.00 </span></b> <br>
                <b class=".text-green-400 text-2xl ">Current: <span>GHS 20.00</span></b>
                <p class="text-sm font-semibold text-accent "> 100  more payments at base price (GHS 10.00 )</p>
            </div>
        </header>
        <hr>
        <section class="mt-5">
