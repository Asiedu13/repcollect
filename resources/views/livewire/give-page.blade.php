<div class="bg-primary text-secondary border border-neutral w-[700px] h-fit py-5 rounded-md">
    {{-- The whole world belongs to you. --}}
      <header x-data="{show: false}" class="flex justify-between text-neutral font-semibold items-center py-4 px-4">
            ...
            <section class="flex gap-2">
                ...
                <a class="flex gap-2 font-normal items-center text-sm text-secondary" wire:navigate>
    ...
    <form wire:submit="redirectToGateway" class="mx-4">
        ...
        <div  class="mt-10 flex mb-10">
                <button @click="showModal = true" class="bg-secondary p-1 h-[40px] rounded-md text-primary flex justify-center items-center w-[100%] text-sm gap-5 hover:bg-gray-800"> Proceed to payment
                     <div wire:loading>
