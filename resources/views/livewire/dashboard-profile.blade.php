            ...
            <section class="p-4 border border-gray-200 rounded-lg" x-data="{save: false}">
                <header class="flex justify-between items-center">
                    <h2 class="font-medium text-gray-500">Personal Information</h2>
                     ...
                     <!-- Save button -->
                     <button x-show="save"  @click="$dispatch('save-personal'); save = false; updateUser" class="flex items-center justify-center gap-2 border border-gray-200 py-2 px-4 rounded-full text-gray-400 text-sm font-medium w-fit h-fit self-center hover:bg-gray-400 hover:text-white delay-150">
                         Save
