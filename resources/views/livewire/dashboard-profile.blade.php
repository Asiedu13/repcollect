<main x-data="{approveDelete: false}" class="bg-transparent mt-5 rounded-md lg:.h-[600px] lg:w-[700px] flex flex-start flex-col px-2">
        <header class="flex gap-2 text-neutral font-semibold items-center py-4 px-4">
            ...
            <a href="#" class="flex gap-2 font-normal items-center text-sm text-secondary">
        ...
        <main class="mt-5 flex flex-col gap-4 .lg:overflow-y-scroll">
            <section x-data="{save: false, selectedFile: null, fileReader: null}" class="flex gap-5 border border-neutral rounded-lg p-4">
                ...
                <div class="flex flex-1 justify-between text-neutral">
                    <div class="flex flex-col bg-primary">
                        <input
                            ...
                            class="text-xl .text-primary font-medium bg-transparent  border-none" 
                            disabled />
                        <input 
                            wire:model="email"
                            name="email"
                        ...
                        <input
                            ...
                            class=".text-primary font-medium bg-transparent" 
                            value="Accra, Ghana" name="country" disabled />
                    </div>
            </section>

            <section class="p-4 border border-gray-200 rounded-lg text-neutral" x-data="{save: false}">
                <header class="flex justify-between items-center">
                    <h2 class="font-medium text-neutral">Personal Information</h2>
                     <!-- edit icon goes here -->
                     <button x-show="! save" @click="$dispatch('edit-personal'); save = true" class="flex items-center justify-center gap-2 py-2 px-4 rounded-full text-accent bg-secondary text-sm font-medium w-fit h-fit self-center hover:bg-primary-hover hover:text-neutral transition delay-150">
                         Edit
                     ...
                     <!-- Save button -->
                     <button x-show="save"  @click="$dispatch('save-personal'); save = false; updateUser" class="flex items-center justify-center gap-2 py-2 px-4 rounded-full text-accent bg-secondary text-sm font-medium w-fit h-fit self-center hover:bg-primary-hover hover:text-neutral transition delay-150">
                         Save
                ...
                <section class="grid lg:grid-cols-2 bg-transparent">
                    <div class="flex flex-col my-2">
                        <label class=".text-gray-400">Username</label>
                        <input class="bg-transparent"
                            wire:model="username"
                            @save-personal.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'text-gray-500 bg-white border-none p-0 my-0'); $wire.updateUser()" 
                            @edit-personal.window="$el.removeAttribute('disabled'); $el.setAttribute('class', 'text-primary p-2 border rounded-md')" id="firstname" class="font-medium bg-transparent text-gray-600" type="text" name="firstname" disabled 
                        />
                        @error('username')
                    ...
                    <div class="flex flex-col my-2">
                        ...
                        <input class="bg-transparent"
                            ...
                            @edit-personal.window="$el.removeAttribute('disabled'); $el.setAttribute('class', 'text-primary p-2 border rounded-md')" id="firstname" class="font-medium bg-white text-gray-600" type="text" name="email" disabled 
                        />
                        @error('email')
                            <p class="text-red-400 text-sm mt-5 flex gap-2">
                                <span> 
                    ...
                    <div class="flex flex-col my-2">
                        ...
                        <input 
                            ...
                            wire:model="phone"
                            @save-personal.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'text-gray-500 bg-white border-none p-0 my-0')" 
                            @edit-personal.window="$el.removeAttribute('disabled'); $el.setAttribute('class', 'text-primary p-2 border rounded-md')" id="phone" class="font-medium bg-white text-gray-600" type="text" name="phone" disabled 
                        />
                        @error('phone')
                            <p class="text-red-400 text-sm mt-5 flex gap-2">
                                <span> 
                    ...
                    <div class="flex flex-col my-2">
                        ...
                        <input class="bg-transparent"
                            wire:model="bio"
                            @save-personal.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'text-gray-500 bg-white border-none p-0 my-0')" 
                            @edit-personal.window="$el.removeAttribute('disabled'); $el.setAttribute('class', 'text-primary p-2 border rounded-md')" id="firstname" class="font-medium bg-white text-gray-600" type="text" value="Down to Earth but still above you" name="bio" disabled 
                        />
                    </div>
                </section>
            </section>
            <!-- Financial preferences -->
            <section class="p-4 border border-neutral rounded-lg" x-data="{save: false}">
                <header class="flex justify-between items-center">
                    <h2 class="font-medium text-neutral">Financial Preferences</h2>
                     <!-- edit icon goes here -->
                     <button x-show="! save" @click="$dispatch('edit-financial'); save = true" class="flex items-center justify-center gap-2 py-2 px-4 rounded-full text-accent bg-secondary text-sm font-medium w-fit h-fit self-center hover:bg-primary-hover hover:text-neutral transition delay-150">
                         Edit
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil-line"><path d="M12 20h9"/><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z"/><path d="m15 5 3 3"/></svg>
                     </button>
                     <!-- Save button -->
                     <button x-show="save"  @click="$dispatch('save-financial'); save = false; $wire.updateUser ();" class="flex items-center justify-center gap-2 py-2 px-4 rounded-full text-accent bg-secondary text-sm font-medium w-fit h-fit self-center hover:bg-primary-hover hover:text-neutral transition delay-150">
                         Save
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-save"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></svg>
                    </button>
                </header>
                <section class="grid lg:grid-cols-2">
                    <div class="flex flex-col my-2">
                        ...
                        <select 
                            wire:model="currency"
                            @save-financial.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'text-gray-500 border-none p-0 my-0'); updateUser;" 
                            @edit-financial.window="$el.removeAttribute('disabled'); $el.setAttribute('class', '.text-xl p-2 border rounded-md')" id="currency" class="font-medium bg-transparent text-neutral" type="text" name="currency" disabled 
                        > 
                    ...
                    <div class="flex flex-col my-2">
                        <label class="text-neutral">Timezone</label>
                        <select
                            wire:model="timezone"
                            @save-financial.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'text-gray-500 bg-secondary border-none p-0 my-0')" 
                            @edit-financial.window="$el.removeAttribute('disabled'); $el.setAttribute('class', '.text-xl p-2 border rounded-md')" id="timezone" class="font-medium bg-transparent text-neutral" type="text" name="timezone" disabled 
                        > 
                    ...
                    <div class="flex flex-col my-2">
                        <label class="text-neutral">Language</label>
                        <select 
                            wire:model="language"
                            @save-financial.window="$el.setAttribute('disabled', 'true'); $el.setAttribute('class', 'text-gray-500 bg-white border-none p-0 my-0')" 
                            @edit-financial.window="$el.removeAttribute('disabled'); $el.setAttribute('class', '.text-xl p-2 border rounded-md')" id="language" class="font-medium bg-transparent text-neutral" type="text" name="language" disabled 
                        >
