    ...
    <section class="flex flex-col gap-2 justify-center .items-center rounded-md p-1 lg:w-2/4 .w-[500px] shadow-md">
        <x-ui.container>
            ...
            <div class="mt-10 mb-10">
                <x-ui.button type="submit" className="bg-gradient-to-r from-brand-blue to-brand-teal text-white p-1 h-[40px] rounded-md flex justify-center items-center w-full text-sm gap-5"> Create Collection Point
                     <div wire:loading>
