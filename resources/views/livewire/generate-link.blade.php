<div class="flex justify-center items-center h-[500px]">
    <section x-data = "{ copied: false }" class="bg-white lg:w-[500px] py-10 rounded-md px-6 text-gray-600">
        ...
        <div class="rounded-md my-2 ml-10 w-fit flex">
            <input class="border px-2 rounded-md w-[300px] lg:w-[400px] outline-none" type="text" id='link' x-ref='linkToCopy' value="{{url("/pay/$link")}}" readonly>
        </div>
        ...
        <div class="ml-10 flex gap-5 mt-10">
            ...
            <p class="px-10 mt-5" x-show="copied">Copied to clipboard!</p>
</section>
</div>
