<div class="flex gap-10 .flex-col justify-between .items-center">
    ...
    <section class="flex flex-col .justify-center .items-center">
        ...
        <nav class="bg-white p-4 rounded-md mt-20 text-slate-600">
            ...
            <ul>
                <li class="flex gap-2 items-center h-[50px] .my-2 cursor-pointer hover:border-2 hover:border-slate-600 hover:rounded-md .hover:text-white hover:px-4 transition-all {{$view == 'collections' ? 'bg-slate-600 text-white px-4 rounded-md' : 'bg-white text-slate-600' }} "  wire:click="handleMenuClick('collections')">
                 ...
                 <li class="flex gap-2 items-center h-[50px] my-2 cursor-pointer hover:border-2 hover:border-slate-600 hover:rounded-md .hover:text-white hover:px-4 transition-all {{$view == 'settings' ? 'bg-slate-600 text-white px-4 rounded-md' : 'bg-white text-slate-600' }} "  wire:click="handleMenuClick('settings')">
                 ...
                 <li class="flex gap-2 items-center h-[50px] .my-2 cursor-pointer hover:border-2 hover:border-slate-600 hover:rounded-md .hover:text-white hover:px-4 transition-all {{$view == 'statistics' ? 'bg-slate-600 text-white px-4 rounded-md' : 'bg-white text-slate-600' }} "   wire:click="handleMenuClick('statistics')">
    ...
    @if($view == 'collections')
        <main class="bg-white mt-5 rounded-md h-[fit] lg:w-[700px] flex flex-start flex-col .container px-2">
            <header class="flex gap-2 text-sky-500 items-center py-4 px-4">
