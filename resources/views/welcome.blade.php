    ...
    <main class="container">
       <section class="flex flex-col h-[550px] justify-center items-center w-[inherit]">
        ...
        <div class="w-[500px] my-[40px] ">
            ...
            <ol class=" mx-[20px]">
                <li class="flex gap-2">1. Create a link <a href="{{route('me.collect')}}" class="bg-blue-400 text-white text-sm p-1 rounded-md w-[120px] flex gap-2 items-center justify-center">
